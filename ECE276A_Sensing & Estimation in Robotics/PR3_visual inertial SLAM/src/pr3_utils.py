...
def visualize_trajectory_2d_with_landmarks(pose,landmarks,path_name="Unknown",show_ori=False):
    '''
    function to visualize the trajectory in 2D
    Input:
        pose:   4*4*N matrix representing the camera pose, 
    ...
    # plot landmark here
    landmark_x = landmarks.landmark_mean[0,:]
    landmark_y = landmarks.landmark_mean[1,:]
    ax.scatter(landmark_x, landmark_y, s = 0.5)
